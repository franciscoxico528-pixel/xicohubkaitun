...
function cac()
    ...
    local W = game:HttpGet('https://raw.githubusercontent.com/q8ta0e/NanoXHub/main/ForKaitun/ListBoss.lua')
        ...
        for y, L in (h) do
            ...
            elseif not X then
                if (os.time() - LastFound) > 200 then
                    alert('cac', 'Error while farming, rejoin')
                    game.Players.LocalPlayer:Kick('Rejoining..')
                    return
                end
    ...
    k:RegisterNotifyListener("elite", function()
        FunctionsHandler.Yama:Set('EliteCount', Remotes.CommF_:InvokeServer("EliteHunter", "Progress"))
        alert("cac", "Elite defeated: " .. tostring(FunctionsHandler.Yama:Get("EliteCount") or 'n/a'))
    end)
